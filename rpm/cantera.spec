...
%set_build_flags
%if 0%{?fedora}
    scons build prefix=%{_prefix} libdirname=%{_lib} system_sundials=y f90_interface=y renamed_shared_libraries=n python_package=full python_prefix=%{_prefix} system_eigen=y extra_inc_dirs=/usr/include/eigen3 system_fmt=y
%endif
